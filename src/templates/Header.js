...
function Header(props){
    ...
    function ShowUserVisibility(props) {
        ...
        if (isOnline) {
            return(
                <div style={{height: "10px", width: "10px", backgroundColor: "#09ba00", borderRadius:"50%", position: "absolute", marginLeft: "79%", marginTop: "-10px"}}></div>
            );
        }
        return(
            <div style={{height: "10px", width: "10px", backgroundColor: "#ba0000", borderRadius:"50%", position: "absolute", marginLeft: "79%", marginTop: "-10px"}}></div>
        );
    } 
            ...
            <nav className="navbar navbar-light" style={{backgroundColor: "#6551b8"}}>
                <div className="container-fluid">
                    ...
                    <div className="col-md-4 text-right">
                        ...
                        &nbsp;
                        <button className="btn btn-light text-white" style={{backgroundColor: "#6551b8"}} onClick={() => window.location.replace("http://localhost:3000")}>{'x'}</button>
                    </div>
                </div>
            </nav>
        </div>
